...
| Product media observations | not implemented; research contract in `docs/research/multimodal-grounded-customer-service.md` | planned/shadow-first | Convert product-scoped images or video frames into attributable OCR and visual observations through staging and review; a media role alone is not an observation |
