...
| Product media observations | `app/services/product_media_observation_service.py`, `app/services/product_media_observation_v3_service.py`, `app/services/product_media_observation_review_service.py` | shadow-only / v2 legacy staging / v3 planned review | V3 binds a visual claim to a product, packaging, component, accessory, included item, or display prop plus state and object/label regions. It remains outside Product Evidence Pack, Grounded Reasoning, and delivery until a later review and evaluation gate passes. |
