...
- [x] **Step 1: Write the failing fresh-read test**
...
- [x] **Step 3: Implement minimal profile provenance**
...
- [x] **Step 4: Implement value-sensitive evidence provenance**
...
- [x] **Step 6: Add and pass the deletion test**
...
- [x] **Step 1: Write the failing exact-variant tests**
...
- [x] **Step 3: Implement exact row selection**
...
- [x] **Step 4: Preserve base-product multi-variant behavior**
...
- [x] **Step 5: Project exact scope and verify GREEN**
...
- [x] **Step 1: Run focused and adjacent regression**

Run:

```powershell
& 'D:\桌面文件\客服\.codex-runtime\venvs\copilot-rebuild\Scripts\python.exe' -m pytest tests\test_product_context_pack_service.py tests\test_admitted_answer_context_service.py tests\test_formal_evidence_convergence.py tests\test_formal_evidence_funnel.py tests\test_docs_governance.py -q
```
