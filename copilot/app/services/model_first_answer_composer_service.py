    ...
    def _system_prompt(
        ...
        *,
        ...
        return mode_contract + (
            ...
            "Do not expose internal slot names or Provider/tool names. Never claim a planned action already happened. "
            "When a service action has completed=true, accurately summarize only the completed outcome stated in its text; "
            "do not turn that operational outcome into product, order-status, or logistics-status evidence. "
            ...
            "an admitted product fact, infer a missing dimension or condition, or remove the unresolved actual-"
            "product boundary."
