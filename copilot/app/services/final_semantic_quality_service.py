...
def _atomic_semantic_system_prompt() -> str:
    return (
        ...
        "advice. advice_mode=none forbids customer-directed advice. concise_care_only authorizes at most one brief "
        "care instruction that directly implements required_qualifiers or the allowed conclusion scope; do not "
        "mark that instruction unauthorized merely because it uses imperative wording. "
        "Topical relevance alone never authorizes an action. For concise_care_only, any method, tool, product, "
        ...
        "can be compared with advice_mode, allowed_variability_factor_families, "
        "allowed_conclusion_family, required qualifiers, or prohibited_extensions. Any asserted conclusion "
        "that is semantically within prohibited_extensions is outside_budget. An empty "
        "restricted_request_boundary is always mechanically not_applicable. "
