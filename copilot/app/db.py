...
def _migrate_add_columns():
    ...
    eval_table_columns = {
        ...
        "agent_answer_memory": [
            ("product_i_id", "VARCHAR(64)", "''"),
            ("sku_code", "VARCHAR(64)", "''"),
            ("product_title", "VARCHAR(255)", "''"),
            ("product_family", "VARCHAR(128)", "''"),
            ("scenario_type", "VARCHAR(64)", "''"),
            ("query_fact_type", "VARCHAR(64)", "''"),
            ("customer_question_pattern", "TEXT", "''"),
            ("approved_answer", "TEXT", "''"),
            ("reference_reply", "TEXT", "''"),
            ("required_fact_types_json", "TEXT", "'[]'"),
            ("required_evidence_roles_json", "TEXT", "'[]'"),
            ("forbidden_claims_json", "TEXT", "'[]'"),
            ("risk_level", "VARCHAR(16)", "'medium'"),
            ("review_status", "VARCHAR(32)", "'reference_only'"),
            ("answer_quality", "VARCHAR(32)", "'candidate'"),
            ("can_auto_send", "BOOLEAN", "0"),
            ("requires_human_review", "BOOLEAN", "1"),
            ("source_type", "VARCHAR(64)", "''"),
            ("source_id", "VARCHAR(128)", "''"),
            ("source_conversation_id", "VARCHAR(128)", "''"),
            ("source_order_id_hash", "VARCHAR(64)", "''"),
            ("reviewer", "VARCHAR(64)", "''"),
            ("metadata_json", "TEXT", "'{}'"),
        ],
    }
