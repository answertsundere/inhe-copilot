# Simulation Run Report: sim_20260607_120013_a381f8

## Run Configuration

- **Run ID**: sim_20260607_120013_a381f8
- **Mode**: service
- **Offline**: True
- **Started**: 2026-06-07T04:00:13.084269+00:00
- **Completed**: 2026-06-07T04:02:26.100823+00:00
- **Customers**: 50
...
| Scenario | Avg Score |
|----------|-----------|
| after_sales_return | 0.749 |
| complaint_high_risk | 0.776 |
| edge_composite | 0.807 |
| installation | 0.787 |
| logistics | 0.795 |
| pre_sale_product | 0.854 |
...
|----|------|----------|-------|-------|--------|
| C001 | 新手妈妈_小林 | pre_sale_product | 0.889 | 3 | Y |
...
| C007 | 急性子_周先生 | pre_sale_product | 0.770 | 3 | Y |
| C008 | 租房客_小孙 | pre_sale_product | 0.935 | 3 | Y |
...
| C015 | 物流停滞_徐女士 | logistics | 0.805 | 3 | Y |
...
| C024 | 破损换货_罗女士 | after_sales_return | 0.733 | 3 | Y |
...
| C038 | 12315威胁_汪女士 | complaint_high_risk | 0.815 | 3 | Y |
| C039 | 曝光威胁_白女士 | complaint_high_risk | 0.815 | 3 | Y |
| C040 | 假货质疑_江先生 | complaint_high_risk | 0.732 | 3 | Y |
| C041 | 严重破损_孟女士 | complaint_high_risk | 0.780 | 3 | Y |
...
| C047 | 误导性信息_错误订单号 | edge_composite | 0.741 | 3 | Y |
| C048 | 方言错别字_理解困难 | edge_composite | 0.889 | 3 | Y |
| C049 | 反复变卦_今天买明天退 | edge_composite | 0.741 | 3 | Y |
| C050 | 超长会话_20轮马拉松 | edge_composite | 0.874 | 20 | Y |
